...
var car1 = car(brandAuto: "Audi",  color: "clear", yearOfManufacture: 2016, trunkVolume: 580.0 , engineState: .stop, AreWindowsOpen: .open, trunkState: .empty)
var car2 = car(brandAuto: "Opel",  color: "clear", yearOfManufacture: 2017, trunkVolume: 480.0, engineState: .stop, AreWindowsOpen: .close, trunkState: .full)

var truck1 = truck(brandTruck: "BMW",  color: "clear", yearOfManufacture: 2015, truckVolume: 100000.0, engineState: .start, AreWindowsOpen: .open, trunkState: .full)
var truck2 = truck(brandTruck: "Volkswagen",  color: "clear", yearOfManufacture: 2014, truckVolume: 150000.0, engineState: .start, AreWindowsOpen: .close, trunkState: .empty)
